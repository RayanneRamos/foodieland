    ...
    recipeDirections: [
      {
        ...
        directionDescription: "Toast until golden brown and crispy.",
      },
      {
        directionTitle: "Mash avocado",
        directionDescription:
          "Mix avocado with salt, pepper, and lemon juice. Spread it over the toast.",
      },
      {
        directionTitle: "Poach the egg",
        directionDescription:
          "Bring a pot of water to a gentle simmer, add vinegar, swirl the water, and drop in the egg. Cook for 3 minutes.",
      },
      {
        directionTitle: "Assemble",
        directionDescription:
          "Place the poached egg on the avocado toast and season with red pepper flakes.",
      },
      {
        directionTitle: "Serve",
        directionDescription:
          "Enjoy immediately with your favorite side drink!",
      },
    ],
  },
  {
    ...
    recipeDirections: [
      {
        directionTitle: "Layer the ingredients",
        directionDescription:
          "In a glass or bowl, add a layer of Greek yogurt, followed by a layer of berries and granola.",
      },
      {
        directionTitle: "Repeat",
        directionDescription:
          "Add another layer of yogurt, then more berries and granola.",
      },
      {
        directionTitle: "Drizzle honey",
        directionDescription: "For extra sweetness, drizzle with honey.",
      },
      {
        directionTitle: "Serve immediately",
        directionDescription: "Enjoy as a light and refreshing breakfast!",
      },
    ],
  },
  // Vegan
