    ...
    <div className={styles.container}>
      ...
      <div className={styles.socialContainer}>
        <div className={styles.socialContent}>
          <strong className={styles.socialTitle}>Check out @foodieland on Instagram</strong>
          <span className={styles.socialSubtitle}>Lorem ipsum dolor sit amet, consectetuipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqut enim ad minim </span>
